...
export class UpdateSales1776333268574 implements MigrationInterface {
    name = 'UpdateSales1776333268574'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`sales\` CHANGE \`product_price_history_id\` \`product_batch_id\` int NULL `);
        ...
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`max_quantity_notification\` \`max_quantity_notification\` decimal(18,2) NOT NULL DEFAULT '0.00'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`unit_id\` \`unit_id\` int NULL `);
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`user_id\` \`user_id\` int NULL `);
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`max_quantity_notification\` \`max_quantity_notification\` decimal(18,2) NULL `);
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`quick_code\` \`quick_code\` varchar(20) NULL `);
        await queryRunner.query(`ALTER TABLE \`product\` CHANGE \`barcode\` \`barcode\` varchar(255) NULL `);
        await queryRunner.query(`CREATE INDEX \`idx_low_stock_by_user\` ON \`product\` (\`user_id\`, \`isLowStock\`)`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_a9965a3d21b6af1edf21c91260\` ON \`product\` (\`name\`, \`user_id\`)`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_5f5ced72b895decbd4ca0318c5\` ON \`unit\` (\`label\`, \`userId\`)`);
        await queryRunner.query(`ALTER TABLE \`unit\` ADD CONSTRAINT \`FK_745632f9034cd78ed2fbea6cd1a\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`sales\` CHANGE \`product_batch_id\` \`product_price_history_id\` int NULL `);
    }
