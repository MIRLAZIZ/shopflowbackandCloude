...
export class ProductsPurchePriceAdd1780423557100 implements MigrationInterface {
    name = 'ProductsPurchePriceAdd1780423557100'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`product\` ADD \`purchase_price\` decimal(18,2) NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_5f5ced72b895decbd4ca0318c5\` ON \`unit\` (\`label\`, \`userId\`)`);
        await queryRunner.query(`ALTER TABLE \`unit\` ADD CONSTRAINT \`FK_745632f9034cd78ed2fbea6cd1a\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`product\` DROP COLUMN \`purchase_price\``);
    }
